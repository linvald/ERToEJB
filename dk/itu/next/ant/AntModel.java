...
public class AntModel {
  ...
  private dk.itu.next.ant.XmlHandler _xmlHandler = null;
  ...
  private StatusPanelOutStreamed _statusText=null;
  public int _debugLevel;
  private MyBuildEventListener antListener = null;


  public AntModel(File buildFile, StatusPanelOutStreamed statusText) {
  ...
  public void loadProject() {
   ...
   public void setStatus(String status){
     ...
     this._statusText.setStatus( status + "\n");
   }
...
public void persistProperties(Properties props) {
	FileWriter writer = null;
	try {
		System.out.println("File:" + this._pathToPropertyFile);
		writer = new FileWriter(this._pathToPropertyFile);
		BufferedWriter buf = new BufferedWriter(writer);
  ...
  public void updateProperty(String key , String newVal){
	Properties properties = new Properties();
	try {
		FileInputStream fis = new FileInputStream(this._pathToPropertyFile);
		properties.load(fis);
		this._project.setProperty(key,newVal);
	...
	System.out.println("Old propvalue:" + properties.get(key));
	properties.put(key, newVal);
	System.out.println("New propvalue:" + properties.get(key));
